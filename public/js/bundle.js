...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW5nZWxvZnBjIiwiYSI6ImNrOWlwN25zYTA1OGkzZHRqazBvNG5oeHQifQ.3PDzHdDhQf36Hwp6Q3JsTw';
...
var stripe = Stripe('pk_test_51GqmM9EfUzhXQujvN9wS4YLhG2UTeOHCJc2ZGmsYfUhVxqAihQ7xio54nlJylY2AhEfpTctOcCMgmJfr7qVb2P0a00FDWGi89v');
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId; //tour-id from html get converted to tourId automatically by js and we used destructuring on it since we are giving it same names
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "8022" + '/');
